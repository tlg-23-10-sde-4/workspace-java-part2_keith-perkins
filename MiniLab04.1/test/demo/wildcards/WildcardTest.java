...
public class WildcardTest {
     ...
     */
    private double sum(Collection<? extends Number> values) {  // collection of anything as long as that thing IS-A number
        double sum = 0.0;          // if what you're trying to do makes IS-A sense, then it's okay
