...
public class CatalogTest {
    ...
    @Test
    public void findByBrands_shouldReturnUnpopulatedMap_OffbrandPassed() {
        Map<String, Collection<Television>> tvMap = Catalog.findByBrands();
        Collection<Television> offBrandTvs = tvMap.get("OffBrand");
        //  for (Television tv : offBrandTvs) {
        assertTrue(tvMap.values().isEmpty());
    }
...
//    assertNotNull(tvs);           commented out
